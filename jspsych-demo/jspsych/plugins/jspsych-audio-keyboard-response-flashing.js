...
jsPsych.plugins["audio-keyboard-response-flashing"] = (function() {

    var plugin = {};

    jsPsych.pluginAPI.registerPreload('audio-keyboard-response-flashing', 'stimulus', 'audio');

    plugin.info = {
        name: 'audio-keyboard-response-flashing',
        description: '',
        parameters: {
            stimulus: {
    ...
    plugin.trial = function(display_element, trial) {
        ...
        // blinking: https://studio.code.org/docs/applab/setInterval/
